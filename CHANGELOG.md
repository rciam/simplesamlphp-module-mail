...
- Support for adding verified email address based on identity provider's scopes
...
- `AddVerifiedEmailAttribute` filter for adding an attribute that contains the verified email address(es) of the user
